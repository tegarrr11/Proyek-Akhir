    ...
    <div class="!p-3">
      ...
      <nav class="space-y-2">
        <a href="{{ route('bem.dashboard') }}"
           ...
           {{ request()->routeIs('bem.dashboard') || request()->routeIs('bem.auditorium') || request()->routeIs('bem.gsg') || request()->routeIs('bem.gor') ? 'bg-[#01425D] text-[#FFFFFF]' : 'text-gray-600 hover:bg-gray-100' }}">
        ...
        <a href="{{ route('bem.peminjaman') }}"
           class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium
           {{ request()->routeIs('bem.peminjaman') ? 'bg-[#01425D] text-[#FFFFFF]' : 'text-gray-600 hover:bg-gray-100' }}">
