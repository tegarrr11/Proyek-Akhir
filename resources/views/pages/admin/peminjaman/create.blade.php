...
<x-header title="Peminjaman" breadcrumb="Peminjaman > Admin - Ajukan Peminjaman" />

<form id="peminjamanForm" method="POST" action="{{ route('admin.peminjaman.store') }}" onsubmit="return validateAndSubmit(event)">
  @csrf
