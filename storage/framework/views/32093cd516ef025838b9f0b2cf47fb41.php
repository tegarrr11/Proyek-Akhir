...
<body class="bg-[#eaf6fb] h-screen grid grid-cols-1 md:grid-cols-[256px_1fr]">
  ...
  <header class="md:hidden flex justify-between items-center px-4 py-3 bg-white border-b">
    ...
    <div class="relative" x-data="notifDropdown()">
      ...
      <div x-show="open" x-cloak @click.away="open = false" class="absolute right-0 mt-2 w-72 bg-white border shadow-lg rounded-lg z-50" x-transition>
  ...
  <!-- Sidebar -->
  <aside id="sidebar" class=" bg-white border-r flex flex-col justify-between md:static fixed inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-40">
    <div class="!p-3">
      <div class="text-center mb-6 md:mt-12 md:mb-8 block">
      ...
      <nav class="space-y-2">
        <a href="<?php echo e(route('mahasiswa.dashboard')); ?>"
          class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('mahasiswa.dashboard') || request()->routeIs('mahasiswa.auditorium') || request()->routeIs('mahasiswa.gsg') || request()->routeIs('mahasiswa.gor') ? 'bg-[#01425D] text-[#FFFFFF]' : 'text-gray-600 hover:bg-gray-100'); ?>">
        ...
        <a href="<?php echo e(route('mahasiswa.fasilitas')); ?>"
          class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('mahasiswa.fasilitas') || request()->routeIs('peminjaman.create') ? 'bg-[#01425D] text-[#FFFFFF]' : 'text-gray-600 hover:bg-gray-100'); ?>">
        ...
        <a href="<?php echo e(route('mahasiswa.peminjaman')); ?>"
          class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('mahasiswa.peminjaman*') ? 'bg-[#01425D] text-[#FFFFFF]' : 'text-gray-600 hover:bg-gray-100'); ?>">
...
</html><?php /**PATH C:\Users\Acer\Documents\SIMFasilitas\Proyek-Akhir\resources\views/layouts/sidebar-mahasiswa.blade.php ENDPATH**/ ?>