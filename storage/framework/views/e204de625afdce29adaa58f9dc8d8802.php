...
<?php $component->withAttributes([]); ?>
    <table class="min-w-full bg-white border rounded-lg mt-4">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="4" class="text-center py-4 text-gray-500">Belum ada riwayat.</td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
<?php endif; ?><?php /**PATH C:\Users\User\Documents\Proyek-Akhir\resources\views/components/riwayat/table-riwayat-dosen.blade.php ENDPATH**/ ?>