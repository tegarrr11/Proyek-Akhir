...
<?php endif; ?>
  ...
  <div class="bg-white rounded-md shadow flex-1 p-6">
    ...
    <div id="pengajuanTab">
        <?php echo $__env->make('components.pengajuan.table-pengajuan-dosen', ['items' => $pengajuans], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    
    <div id="riwayatTab" class="hidden">
        <?php echo $__env->make('components.riwayat.table-riwayat-dosen', ['items' => $riwayats], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </div>
...
<?php echo $__env->make('layouts.sidebar-dosen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\SIMFasilitas\Proyek-Akhir\resources\views/pages/dosen/peminjaman.blade.php ENDPATH**/ ?>