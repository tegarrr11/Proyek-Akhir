    ...
    <div class="!p-3">
      ...
      <nav class="space-y-2">
        <a href="<?php echo e(route('bem.dashboard')); ?>"
           ...
           <?php echo e(request()->routeIs('bem.dashboard') || request()->routeIs('bem.auditorium') || request()->routeIs('bem.gsg') || request()->routeIs('bem.gor') ? 'bg-[#c4f7fd] text-[#003366]' : 'text-gray-600 hover:bg-gray-100'); ?>">
        ...
        <a href="<?php echo e(route('bem.peminjaman')); ?>"
           class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium
           <?php echo e(request()->routeIs('bem.peminjaman') ? 'bg-[#c4f7fd] text-[#003366]' : 'text-gray-600 hover:bg-gray-100'); ?>">
