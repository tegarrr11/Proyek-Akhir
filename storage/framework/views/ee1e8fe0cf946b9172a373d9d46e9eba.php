  ...
  <table class="w-full text-sm">
    ...
    <tbody>
      ...
      <tr class="<?php echo e($i % 2 == 0 ? 'bg-white' : 'bg-gray-50'); ?>"
          data-row-id="row-<?php echo e($item->id); ?>">
        ...
        <td class="px-2 py-2">
          <div class="flex items-center gap-2">
              <!-- ajukan -->
            <?php if($item->verifikasi_sarpras === 'pending'): ?>
              <button type="button"
                data-action="ajukan"
                onclick="markAjukan('<?php echo e(route('admin.peminjaman.ajukan', $item->id)); ?>', <?php echo e($item->id); ?>)"
            ...
            <?php endif; ?>
              <!-- edit -->
              <button onclick="fetchAndShowEditModal(<?php echo e($item->id); ?>)" class="text-gray-600 hover:text-blue-700" title="Edit Detail">
...
<?php endif; ?>
<?php echo $__env->make('components.modal-edit-detail-peminjaman', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\User\Documents\Proyek-Akhir\resources\views/components/pengajuan/table-pengajuan-mahasiswa.blade.php ENDPATH**/ ?>