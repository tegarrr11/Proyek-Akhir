  ...
  <table class="w-full text-sm">
    ...
    <tbody>
      ...
      <tr class="<?php echo e($i % 2 == 0 ? 'bg-white' : 'bg-gray-50'); ?>">
        ...
        <td class="px-4 py-2">
          <span class="px-3 py-1 text-xs rounded-full <?php echo e($item->verifikasi_bem === 'diterima' ? 'bg-green-100 text-green-600 text-xs px-3 py-1 rounded-full font-medium' : 'bg-gray-200 text-gray-600 text-xs px-3 py-1 rounded-full font-medium'); ?>">
