...
<div class="bg-white rounded-md shadow !p-6" x-data="{ tab: '<?php echo e(request('tab') ?? $gedungs->first()->id); ?>' }">
...
<?php /**PATH C:\Users\User\Documents\Proyek-Akhir\resources\views/components/table-fasilitas.blade.php ENDPATH**/ ?>