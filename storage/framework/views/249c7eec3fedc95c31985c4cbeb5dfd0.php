...
<div id="calendar-detail-modal" class="fixed inset-0 z-50 hidden bg-black/30 flex items-center justify-center">
  <div class="bg-[#f0f8fa] rounded-2xl w-[380px] p-5 shadow-lg relative">
    ...
    <div class="flex items-start gap-2">
      ...
      <p id="modal-penanggung-jawab" class="text-sm text-gray-700">-</p>
    </div>
...
<script>
  function showDetailModal(data) {
    ...
    document.getElementById('modal-penanggung-jawab').innerText = data.penanggung_jawab || '-';

    // SVG Mahasiswa
    const svgMahasiswa = 
    `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#28839D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-graduation-cap-icon lucide-graduation-cap"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/></svg>`;
    // SVG Staff/Admin
    const svgStaff = 
    `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#E33C45" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-briefcase-icon lucide-briefcase"><path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><rect width="20" height="14" x="2" y="6" rx="2"/></svg>`;
    ...
    const isMahasiswa = daftarMahasiswa.some(o => organisasi.includes(o));
...
<?php /**PATH C:\Users\User\Documents\Proyek-Akhir\resources\views/components/card-detail-kalender.blade.php ENDPATH**/ ?>