  ...
  <div class="flex items-center justify-between mb-6">
    <div class="flex gap-6 relative">
      ...
      <button onclick="showTab('aktif')" id="tabAktif"
        class="pb-2 relative text-sm font-semibold text-[#003366]">
        <span>Aktif</span>
        <span class="absolute left-0 -bottom-0.5 w-full h-[2px] bg-[#003366] scale-x-100 origin-left transition-transform duration-300" id="underlineAktif"></span>
      </button>
...
<script>
  ...
  function setAktifTabFlag() {
    document.getElementById('tabInput').value = 'aktif';
  }

  function showTab(tab) {
    ['pengajuan','aktif','riwayat'].forEach(id => {
