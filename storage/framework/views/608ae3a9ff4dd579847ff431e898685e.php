    ...
    <div class="p-6">
      ...
      <nav class="space-y-2">
        <a href="<?php echo e(route('admin.dashboard')); ?>"
           ...
           <?php echo e(request()->routeIs('admin.dashboard') || request()->routeIs('admin.auditorium') || request()->routeIs('admin.gsg') || request()->routeIs('admin.gor') ? 'bg-[#c4f7fd] text-[#003366]' : 'text-gray-600 hover:bg-gray-100'); ?>">
        ...
        <a href="<?php echo e(route('admin.fasilitas')); ?>"
          class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium
          <?php echo e(request()->routeIs('admin.fasilitas') ? 'bg-[#c4f7fd] text-[#003366]' : 'text-gray-600 hover:bg-gray-100'); ?>">
        ...
        <a href="<?php echo e(route('admin.peminjaman')); ?>"
           class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium
           <?php echo e(request()->routeIs('admin.peminjaman') ? 'bg-[#c4f7fd] text-[#003366]' : 'text-gray-600 hover:bg-gray-100'); ?>">
