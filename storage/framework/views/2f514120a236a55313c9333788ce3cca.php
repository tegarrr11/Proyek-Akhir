  ...
  <div class="bg-white rounded-md p-6 shadow flex-1 overflow-visible">
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="relative flex items-center gap-2">
        ...
        <!-- Input Search -->
        <form method="GET" action="<?php echo e(route('mahasiswa.peminjaman')); ?>" class="relative">
...
<?php echo $__env->make('layouts.sidebar-mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\Proyek-Akhir\resources\views/pages/mahasiswa/peminjaman.blade.php ENDPATH**/ ?>