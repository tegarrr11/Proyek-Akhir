      ...
      <tr class="<?php echo e($i % 2 == 0 ? 'bg-white' : 'bg-gray-50'); ?>">
        ...
        <td class="px-4 py-2">
          <span class="px-3 py-1 text-xs rounded-full
            ...
            <?php endif; ?>">
            <?php echo e(in_array($item->verifikasi_sarpras, ['diajukan', null, '']) ? '-' : ucfirst($item->verifikasi_sarpras)); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Acer\Documents\SIMFasilitas\Proyek-Akhir\resources\views/components/riwayat/table-riwayat-mahasiswa.blade.php ENDPATH**/ ?>