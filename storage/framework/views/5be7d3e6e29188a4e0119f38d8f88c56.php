  ...
  <div class="mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-2">
      <div>
        ...
        <input type="date" name="tgl_kegiatan" id="tgl_kegiatan" value="<?php echo e(old('tgl_kegiatan', request('tgl_kegiatan'))); ?>"
      ...
      <div>
        ...
        <input type="date" name="tgl_kegiatan_berakhir" id="tgl_kegiatan_berakhir" value="<?php echo e(old('tgl_kegiatan_berakhir', request('tgl_kegiatan_berakhir'))); ?>"
          class="w-full border border-gray-500 rounded px-3 py-2" required>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 items-end">
      <div>
        ...
        <input type="time" name="waktu_mulai" id="waktu_mulai" value="<?php echo e(old('waktu_mulai', request('waktu_mulai'))); ?>"
          class="w-full border border-gray-500 rounded px-3 py-2" required>
      </div>
      <div>
        <label class="block text-xs text-gray-600 mb-1">Jam Berakhir</label>
        <input type="time" name="waktu_berakhir" id="waktu_berakhir" value="<?php echo e(old('waktu_berakhir', request('waktu_berakhir'))); ?>"
          class="w-full border border-gray-500 rounded px-3 py-2" required>
      </div>
    </div>
