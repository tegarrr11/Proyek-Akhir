...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.header','data' => ['title' => 'Fasilitas','breadcrumb' => 'Fasilitas > Prosedur Peminjaman']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Fasilitas','breadcrumb' => 'Fasilitas > Prosedur Peminjaman']); ?>
  ...
  <div class="bg-white p-6 rounded-md shadow-md">
    <div class="flex justify-between items-center mb-6">
      ...
      <a href="<?php echo e(route('peminjaman.create')); ?>" 
        class="bg-[#3389CA] hover:bg-[#002952] text-white px-4 py-2 rounded text-sm flex items-center gap-2">
    ...
    <div class="space-y-4">
      ...
      <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex items-start bg-[#e0f7fa] p-4 rounded-md gap-4 shadow-sm">
          ...
          <div>
            <h2 class="font-semibold text-sm text-[#003366]"><?php echo e($step['title']); ?></h2>
            <div class="text-sm text-gray-700"><?php echo $step['desc']; ?></div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.sidebar-mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\SIMFasilitas\Proyek-Akhir\resources\views/pages/mahasiswa/fasilitas.blade.php ENDPATH**/ ?>